    ...
    const bundle = await rollup({
      ...
      plugins: [
        virtual({
          ...
          'fastly:geolocation': `export const getGeolocationForIpAddress = globalThis.fastly.getGeolocationForIpAddress`,
          'fastly:logger': `export const Logger = globalThis.Logger`,
