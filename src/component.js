...
export async function compileComponent (path) {
  ...
  const generatedComponent = await componentNew(coreComponentEmbedded, [['wasi_snapshot_preview1', await readFile(new URL('../wasi_snapshot_preview1.command.wasm', import.meta.url))]]);
