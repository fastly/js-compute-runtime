addEventListener("fetch", (event) => {
    ...
    if (downstreamRequest.method != method) {
        throw new Error("downstreamRequest.method() did not return " +
            method +
            ", instead returned: " +
    ...
    if (downstreamRequest.url != url.href) {
        throw new Error("downstreamRequest.url did not return " +
            url.href +
            ", instead returned: " +
    ...
    if (downstreamClientIpString != localhostIp) {
        throw new Error("Fastly.getClientIpAddressString() did not return " +
            localhostIp +
            ", instead returned: " +
