...
routes.set('/proxy-transform-stream/content-length', async (event) => {
  let request = new Request(
    '/proxy-transform-stream/content-length/backend',
    event.request,
  );
...
routes.set(
  '/proxy-transform-stream/simple-response-body-chain/backend',
  async (event) => {
...
routes.set(
  '/proxy-transform-stream/multi-response-body-chain/backend',
  async (event) => {
...
routes.set(
  '/proxy-transform-stream/response-body-into-js/backend',
  async (event) => {
    let res = new Response('body');
