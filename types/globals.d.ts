...
/**
 * Information about the downstream client making the request to the Compute service.
 */
 ...
 *
 * **Note**: On Compute, TextDecoder only supports UTF-8 bytes as input, and always operates
 * in non-fatal mode.
 * @group Encoding API
 */
...
/**
 * Fastly-specific APIs available to Compute JS services
 * @deprecated
 * @hidden
 */
declare interface Fastly {
  ...
  /**
   * Property to access the environment variables for the Compute service.
   * @hidden
   */
  env: {
    /**
  ...
  /**
   * Causes the Compute JS runtime environment to log debug information to stdout.
   *
 ...
 * Compute-specific additions and modifications. Those modifications are
 ...
 *
 * **Note**: Compute requires all outgoing requests to go to a predefined
