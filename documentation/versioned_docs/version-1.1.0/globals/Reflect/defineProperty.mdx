...
[`Object.defineProperty()`](../../globals/Object/defineProperty.md) but returns a `Boolean`.
...
[`Object.defineProperty`](../../globals/Object/defineProperty.md) which is similar.

> **Note:** `Object.defineProperty` returns the
> object or throws a [`TypeError`](../../globals/TypeError/TypeError.md) if the property has not been successfully
