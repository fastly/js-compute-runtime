...
- `options` _**optional**_
  - : An object with configuration properties. For numbers, see [`Number.prototype.toLocaleString()`](../../../globals/Number/prototype/toLocaleString.md); for dates, see [`Date.prototype.toLocaleString()`](../../../globals/Date/prototype/toLocaleString.md).
