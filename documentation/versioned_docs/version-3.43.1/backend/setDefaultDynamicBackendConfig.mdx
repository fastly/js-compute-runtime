  ...
  - : An Object which contains the generic configuration options to apply to newly created Backends.
    ...
    - `clientCertificate` _: object_ _**optional**_
      ...
      - `key` _: SecretStoreEntry_
        - The `SecretStoreEntry` to use for the key, created via [`SecretStore.prototype.get`](pathname://../fastly%3Asecret-store/SecretStore/prototype/get.mdx) or alteratively via [`SecretStore.fromBytes`](pathname://../fastly%3Asecret-store/SecretStore/fromBytes.mdx).
