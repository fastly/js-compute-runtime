...
In addition, custom backend configuration options can then also be provided through the [`Backend()`](pathname://../fastly%3Abackend/Backend/Backend.mdx) constructor.
...
- `options` _**optional**_
  ...
  - : An object containing any custom settings that you want to apply to the request. The
    ...
    - `imageOptimizerOptions` _**Fastly-specific**_, see [`imageOptimizerOptions`](pathname://../fastly%3Aimage-optimizer/imageOptimizerOptions.mdx).
