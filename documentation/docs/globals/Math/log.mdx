...
The **`Math.log()`** function returns the natural logarithm (base [E](./E.md)) of a number.
...
The natural logarithm (base [E](./E.md)) of `x`. If `x` is ±0, returns [`-Infinity`](../Number/NEGATIVE_INFINITY.md). If `x < 0`, returns `NaN`.
