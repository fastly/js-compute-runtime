...
The **`Math.expm1()`** function returns [E](./E.md) raised to the power of a number, subtracted by 1.
...
A number representing e<sup>x</sup> - 1, where e is [the base of the natural logarithm](./E.md).
