...
the values returned from the [`Date.prototype.getUTCMinutes()`](./getUTCMinutes.md), [`Date.prototype.getUTCSeconds()`](./getUTCSeconds.md),
and [`Date.prototype.getUTCMilliseconds()`](./getUTCMilliseconds.md) methods
are used.
