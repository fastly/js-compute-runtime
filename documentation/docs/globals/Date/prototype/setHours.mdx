...
the values returned from the [`Date.prototype.getMinutes()`](./getMinutes.md),
[`Date.prototype.getSeconds()`](./getSeconds.md), and
[`Date.prototype.getMilliseconds()`](./getMilliseconds.md) methods are used.
