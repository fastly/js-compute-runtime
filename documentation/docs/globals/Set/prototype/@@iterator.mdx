...
The initial value of this property is the same function object as the initial value of the [`Set.prototype.values`](../../../globals/Set/prototype/values.md) property.
...
The same return value as [`Set.prototype.values()`](../../../globals/Set/prototype/values.md): a new iterable iterator object that yields the values of the set.
