...
The initial value of this property is the same function object as the initial value of the [`Array.prototype.values`](./values.md) property.
...
The same return value as [`Array.prototype.values()`](./values.md): a new iterable iterator object that yields the value of each index in the array.
