...
The **`get()`** method of the [`Headers`](../../../globals/Headers/Headers.md) interface
...
A [`String`](../../../globals/String/String.md) sequence representing the values of the retrieved header or
