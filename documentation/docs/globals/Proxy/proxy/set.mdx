...
- If the `set()` method returns `false`, and the assignment
  happened in strict-mode code, a [`TypeError`](../../../globals/TypeError/TypeError.md) will be thrown.
...
- [`Reflect.set()`](../../../globals/Reflect/set.md)
...
- In strict mode, a `false` return value from the `set()`
  handler will throw a [`TypeError`](../../../globals/TypeError/TypeError.md) exception.
