...
- `props`
  ...
  - : An object whose keys represent the names of properties to be defined or modified and
    ...
    [`Object.defineProperty()`](../../globals/Object/defineProperty.md) for more details).
    ...
    - `get`
      - : A function which serves as a getter for the property, or [`undefined`](../../globals/undefined.md)
        if there is no getter. The function's return value will be used as the value of
        the property.
        **Defaults to [`undefined`](../../globals/undefined.md).**
    - `set`
      - : A function which serves as a setter for the property, or [`undefined`](../../globals/undefined.md)
