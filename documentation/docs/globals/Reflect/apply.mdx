...
A [`TypeError`](../../globals/TypeError/TypeError.md), if the `target` is not callable.

## Description

In ES5, you typically use the [`Function.prototype.apply()`](../../globals/Function/prototype/apply.md) method to call a
