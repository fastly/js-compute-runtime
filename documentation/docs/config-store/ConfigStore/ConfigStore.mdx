...
The **`ConfigStore` constructor** lets you access a specific [Fastly Edge ConfigStore](https://www.fastly.com/documentation/reference/api/services/resources/config-store/).
