...
int body_append(fastly_compute_at_edge_fastly_body_handle_t dst_handle, fastly_compute_at_edge_fastly_body_handle_t src_handle);
...
int body_read(fastly_compute_at_edge_fastly_body_handle_t body_handle, char *buf, size_t buf_len, size_t *nread);

WASM_IMPORT("fastly_http_body", "write")
int body_write(fastly_compute_at_edge_fastly_body_handle_t body_handle, const char *buf, size_t buf_len, BodyWriteEnd end,
               size_t *nwritten);
...
int log_write(fastly_compute_at_edge_fastly_log_endpoint_handle_t endpoint_handle, const char *msg, size_t msg_len,
              size_t *nwritten);
...
int req_cache_override_set(fastly_compute_at_edge_fastly_request_handle_t req_handle, int tag, uint32_t ttl,
                           uint32_t stale_while_revalidate);

WASM_IMPORT("fastly_http_req", "cache_override_v2_set")
int req_cache_override_v2_set(fastly_compute_at_edge_fastly_request_handle_t req_handle, int tag, uint32_t ttl,
...
int req_header_names_get(fastly_compute_at_edge_fastly_request_handle_t req_handle, char *buf, size_t buf_len,
...
int req_header_value_get(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *name, size_t name_len,
                         char *value, size_t value_max_len, size_t *nwritten);

WASM_IMPORT("fastly_http_req", "header_values_get")
int req_header_values_get(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *name, size_t name_len,
                          char *buf, size_t buf_len, uint32_t cursor, int64_t *ending_cursor,
                          size_t *nwritten);

WASM_IMPORT("fastly_http_req", "header_insert")
int req_header_insert(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *name, size_t name_len,
                      const char *value, size_t value_len);

WASM_IMPORT("fastly_http_req", "header_append")
int req_header_append(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *name, size_t name_len,
                      const char *value, size_t value_len);

WASM_IMPORT("fastly_http_req", "header_remove")
int req_header_remove(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *name, size_t name_len);

WASM_IMPORT("fastly_http_req", "method_get")
int req_method_get(fastly_compute_at_edge_fastly_request_handle_t req_handle, char *method, size_t method_max_len,
                   size_t *nwritten);

WASM_IMPORT("fastly_http_req", "method_set")
int req_method_set(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *method, size_t method_len);

WASM_IMPORT("fastly_http_req", "uri_get")
int req_uri_get(fastly_compute_at_edge_fastly_request_handle_t req_handle, char *uri, size_t uri_max_len,
                size_t *nwritten);

WASM_IMPORT("fastly_http_req", "uri_set")
int req_uri_set(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *uri, size_t uri_len);
...
int req_send(fastly_compute_at_edge_fastly_request_handle_t req_handle, fastly_compute_at_edge_fastly_body_handle_t body_handle,
             const char *backend, size_t backend_len, fastly_compute_at_edge_fastly_response_handle_t *resp_handle_out,
             fastly_compute_at_edge_fastly_body_handle_t *resp_body_handle_out);

WASM_IMPORT("fastly_http_req", "send_async")
int req_send_async(fastly_compute_at_edge_fastly_request_handle_t req_handle, fastly_compute_at_edge_fastly_body_handle_t body_handle,
...
int req_send_async_streaming(fastly_compute_at_edge_fastly_request_handle_t req_handle, fastly_compute_at_edge_fastly_body_handle_t body_handle,
                             const char *backend, size_t backend_len,
                             fastly_compute_at_edge_fastly_pending_request_handle_t *pending_req_out);

WASM_IMPORT("fastly_http_req", "pending_req_poll")
int req_pending_req_poll(fastly_compute_at_edge_fastly_pending_request_handle_t req_handle, uint32_t *is_done_out,
                         fastly_compute_at_edge_fastly_response_handle_t *resp_handle_out,
                         fastly_compute_at_edge_fastly_body_handle_t *resp_body_handle_out);

WASM_IMPORT("fastly_http_req", "pending_req_select")
int req_pending_req_select(fastly_compute_at_edge_fastly_pending_request_handle_t req_handles[], size_t req_handles_len,
                           uint32_t *done_idx_out, fastly_compute_at_edge_fastly_response_handle_t *resp_handle_out,
                           fastly_compute_at_edge_fastly_body_handle_t *resp_body_handle_out);
...
int resp_header_names_get(fastly_compute_at_edge_fastly_response_handle_t resp_handle, char *buf, size_t buf_len,
                          uint32_t cursor, int64_t *ending_cursor, size_t *nwritten);

WASM_IMPORT("fastly_http_resp", "header_values_get")
int resp_header_values_get(fastly_compute_at_edge_fastly_response_handle_t resp_handle, const char *name, size_t name_len,
                           char *buf, size_t buf_len, uint32_t cursor, int64_t *ending_cursor,
                           size_t *nwritten);

WASM_IMPORT("fastly_http_req", "header_values_set")
int req_header_values_set(fastly_compute_at_edge_fastly_request_handle_t req_handle, const char *name, size_t name_len,
                          const char *values, size_t values_len);

WASM_IMPORT("fastly_http_resp", "header_insert")
int resp_header_insert(fastly_compute_at_edge_fastly_response_handle_t resp_handle, const char *name, size_t name_len,
                       const char *value, size_t value_len);

WASM_IMPORT("fastly_http_resp", "header_append")
int resp_header_append(fastly_compute_at_edge_fastly_response_handle_t resp_handle, const char *name, size_t name_len,
                       const char *value, size_t value_len);

WASM_IMPORT("fastly_http_resp", "header_remove")
int resp_header_remove(fastly_compute_at_edge_fastly_response_handle_t resp_handle, const char *name, size_t name_len);

WASM_IMPORT("fastly_http_resp", "version_get")
int resp_version_get(fastly_compute_at_edge_fastly_response_handle_t resp_handle, uint32_t *version_out);

WASM_IMPORT("fastly_http_resp", "send_downstream")
int resp_send_downstream(fastly_compute_at_edge_fastly_response_handle_t resp_handle, fastly_compute_at_edge_fastly_body_handle_t body_handle,
                         uint32_t streaming);

WASM_IMPORT("fastly_http_resp", "status_get")
int resp_status_get(fastly_compute_at_edge_fastly_response_handle_t resp_handle, uint16_t *status_out);
...
int dictionary_open(const char *name, size_t name_len, fastly_compute_at_edge_fastly_dictionary_handle_t *dict_handle_out);

WASM_IMPORT("fastly_dictionary", "get")
int dictionary_get(fastly_compute_at_edge_fastly_dictionary_handle_t dict_handle, const char *key, size_t key_len,
                   char *value, size_t value_max_len, size_t *nwritten);
...
int secret_store_get(fastly_compute_at_edge_fastly_secret_store_handle_t dict_handle, const char *key, size_t key_len,
                     fastly_compute_at_edge_fastly_secret_handle_t *opt_secret_handle_out);

WASM_IMPORT("fastly_secret_store", "plaintext")
int secret_store_plaintext(fastly_compute_at_edge_fastly_secret_handle_t secret_handle, char *buf, size_t buf_len,
                           size_t *nwritten);
...
int object_store_get(fastly_compute_at_edge_fastly_object_store_handle_t object_store_handle, const char *key,
                     size_t key_len, fastly_compute_at_edge_fastly_body_handle_t *opt_body_handle_out);
WASM_IMPORT("fastly_object_store", "insert")
int object_store_insert(fastly_compute_at_edge_fastly_object_store_handle_t object_store_handle, const char *key,
                        size_t key_len, fastly_compute_at_edge_fastly_body_handle_t body_handle);
...
int async_select(fastly_compute_at_edge_fastly_async_handle_t handles[], size_t handles_len, uint32_t timeout_ms,
...
int cache_transaction_insert_and_stream_back(fastly_compute_at_edge_fastly_cache_handle_t handle, uint32_t options_mask,
                                             CacheWriteOptions *options,
                                             fastly_compute_at_edge_fastly_body_handle_t *ret_body,
...
int cache_get_state(fastly_compute_at_edge_fastly_cache_handle_t handle, fastly_compute_at_edge_fastly_cache_lookup_state_t *ret);
...
int cache_get_body(fastly_compute_at_edge_fastly_cache_handle_t handle, uint32_t options_mask,
                   fastly_compute_at_edge_fastly_cache_get_body_options_t *options, fastly_compute_at_edge_fastly_body_handle_t *ret);
