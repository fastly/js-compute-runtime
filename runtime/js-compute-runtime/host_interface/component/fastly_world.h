...
typedef struct {
  ...
  size_t len;
} fastly_compute_at_edge_async_io_list_handle_t;

typedef struct {
  bool is_some;
  uint32_t val;
} fastly_compute_at_edge_async_io_option_u32_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_async_io_option_u32_t ok;
...
} fastly_compute_at_edge_http_types_option_string_t;

typedef struct {
  bool is_some;
  bool val;
} fastly_compute_at_edge_http_types_option_bool_t;
...
typedef struct {
  fastly_compute_at_edge_http_types_option_string_t host_override;
  fastly_compute_at_edge_async_io_option_u32_t connect_timeout;
  fastly_compute_at_edge_async_io_option_u32_t first_byte_timeout;
  fastly_compute_at_edge_async_io_option_u32_t between_bytes_timeout;
  fastly_compute_at_edge_http_types_option_bool_t use_ssl;
  fastly_compute_at_edge_http_types_option_bool_t dont_pool;
  ...
  fastly_compute_at_edge_http_types_option_string_t cert_hostname;
  fastly_compute_at_edge_http_types_option_string_t ca_cert;
  fastly_compute_at_edge_http_types_option_string_t ciphers;
  fastly_compute_at_edge_http_types_option_string_t sni_hostname;
...
typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_http_types_option_string_t ok;
    fastly_compute_at_edge_backend_error_t err;
  } val;
...
} fastly_compute_at_edge_cache_option_request_handle_t;
...
typedef struct {
  ...
  fastly_compute_at_edge_cache_option_request_handle_t request_headers;
} fastly_compute_at_edge_cache_lookup_options_t;

typedef struct {
  uint8_t *ptr;
  size_t len;
} fastly_compute_at_edge_cache_list_u8_t;
...
typedef struct {
  ...
  fastly_compute_at_edge_cache_list_u8_t user_metadata;
  bool sensitive_data;
...
} fastly_compute_at_edge_cache_tuple2_body_handle_handle_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_cache_tuple2_body_handle_handle_t ok;
    fastly_compute_at_edge_cache_error_t err;
  } val;
...
} fastly_compute_at_edge_cache_result_string_error_t;
...
typedef struct {
  bool is_some;
  float val;
} fastly_compute_at_edge_geo_option_float32_t;
...
typedef struct {
  ...
  fastly_compute_at_edge_http_types_option_string_t as_name;
  // * [Autonomous system](https://en.wikipedia.org/wiki/Autonomous_system_(Internet)) (AS) number.
  fastly_compute_at_edge_async_io_option_u32_t as_number;
  ...
  fastly_compute_at_edge_async_io_option_u32_t area_code;
  // * City or town name.
  fastly_compute_at_edge_http_types_option_string_t city;
  // * Connection speed.
  fastly_compute_at_edge_http_types_option_string_t conn_speed;
  // * Connection type.
  fastly_compute_at_edge_http_types_option_string_t conn_type;
  // * Continent.
  fastly_compute_at_edge_http_types_option_string_t continent;
  ...
  fastly_compute_at_edge_http_types_option_string_t country_code;
  ...
  fastly_compute_at_edge_http_types_option_string_t country_code3;
  // * Country name.
  //     *
  //     * This field is the [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1) English short name for a country.
  fastly_compute_at_edge_http_types_option_string_t country_name;
  // * Time zone offset from Greenwich Mean Time (GMT) for `city`.
  fastly_compute_at_edge_http_types_option_string_t gmt_offset;
  ...
  fastly_compute_at_edge_geo_option_float32_t latitude;
  ...
  fastly_compute_at_edge_geo_option_float32_t longitude;
  // * Metro code, representing designated market areas (DMAs) in the United States.
  fastly_compute_at_edge_async_io_option_u32_t metro_code;
  ...
  fastly_compute_at_edge_http_types_option_string_t postal_code;
  // * Client proxy description.
  fastly_compute_at_edge_http_types_option_string_t proxy_description;
  // * Client proxy type.
  fastly_compute_at_edge_http_types_option_string_t proxy_type;
  ...
  fastly_compute_at_edge_http_types_option_string_t region;
  // * Time zone offset from coordinated universal time (UTC) for `city`.
  fastly_compute_at_edge_async_io_option_u32_t utc_offset;
...
typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_cache_list_u8_t ok;
    fastly_compute_at_edge_http_body_error_t err;
  } val;
...
typedef struct {
  ...
  size_t len;
} fastly_compute_at_edge_http_req_list_string_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_http_req_list_string_t ok;
    fastly_compute_at_edge_http_req_error_t err;
  } val;
...
typedef struct {
  bool is_some;
  fastly_compute_at_edge_cache_list_u8_t val;
} fastly_compute_at_edge_http_req_option_list_u8_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_http_req_option_list_u8_t ok;
    fastly_compute_at_edge_http_req_error_t err;
  } val;
} fastly_compute_at_edge_http_req_result_option_list_u8_error_t;

typedef struct {
  fastly_compute_at_edge_cache_list_u8_t *ptr;
  size_t len;
} fastly_compute_at_edge_http_req_list_list_u8_t;

typedef struct {
  bool is_some;
  fastly_compute_at_edge_http_req_list_list_u8_t val;
} fastly_compute_at_edge_http_req_option_list_list_u8_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_http_req_option_list_list_u8_t ok;
    fastly_compute_at_edge_http_req_error_t err;
  } val;
...
} fastly_compute_at_edge_http_req_option_response_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_http_req_option_response_t ok;
    fastly_compute_at_edge_http_req_error_t err;
  } val;
...
typedef struct {
  ...
  size_t len;
} fastly_compute_at_edge_http_req_list_pending_request_handle_t;

typedef struct {
  uint32_t f0;
  fastly_compute_at_edge_http_req_response_t f1;
} fastly_compute_at_edge_http_req_tuple2_u32_response_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_http_req_tuple2_u32_response_t ok;
    fastly_compute_at_edge_http_req_error_t err;
  } val;
...
} fastly_compute_at_edge_object_store_option_body_handle_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_object_store_option_body_handle_t ok;
    fastly_compute_at_edge_object_store_error_t err;
  } val;
...
} fastly_compute_at_edge_secret_store_option_secret_handle_t;

typedef struct {
  bool is_err;
  union {
    fastly_compute_at_edge_secret_store_option_secret_handle_t ok;
    fastly_compute_at_edge_secret_store_error_t err;
  } val;
...
} fastly_compute_at_edge_secret_store_result_option_string_error_t;
...
extern bool fastly_compute_at_edge_async_io_select(fastly_compute_at_edge_async_io_list_handle_t *hs, uint32_t timeout_ms, fastly_compute_at_edge_async_io_option_u32_t *ret, fastly_compute_at_edge_async_io_error_t *err);
...
extern bool fastly_compute_at_edge_backend_get_override_host(fastly_world_string_t *backend, fastly_compute_at_edge_http_types_option_string_t *ret, fastly_compute_at_edge_backend_error_t *err);
...
extern bool fastly_compute_at_edge_cache_transaction_insert_and_stream_back(fastly_compute_at_edge_cache_handle_t handle, fastly_compute_at_edge_cache_write_options_t *options, fastly_compute_at_edge_cache_tuple2_body_handle_handle_t *ret, fastly_compute_at_edge_cache_error_t *err);
...
extern bool fastly_compute_at_edge_cache_transaction_update(fastly_compute_at_edge_cache_handle_t handle, fastly_compute_at_edge_cache_error_t *err);
...
// was no found object.
extern bool fastly_compute_at_edge_cache_get_user_metadata(fastly_compute_at_edge_cache_handle_t handle, fastly_world_string_t *ret, fastly_compute_at_edge_cache_error_t *err);
...
extern bool fastly_compute_at_edge_cache_get_body(fastly_compute_at_edge_cache_handle_t handle, fastly_compute_at_edge_cache_get_body_options_t *options, fastly_compute_at_edge_cache_body_handle_t *ret, fastly_compute_at_edge_cache_error_t *err);
...
extern bool fastly_compute_at_edge_dictionary_get(fastly_compute_at_edge_dictionary_handle_t h, fastly_world_string_t *key, fastly_compute_at_edge_http_types_option_string_t *ret, fastly_compute_at_edge_dictionary_error_t *err);

// Imported Functions from `fastly:compute-at-edge/geo`
// JSON string for now
extern bool fastly_compute_at_edge_geo_lookup(fastly_compute_at_edge_cache_list_u8_t *addr_octets, fastly_world_string_t *ret, fastly_compute_at_edge_geo_error_t *err);
...
extern bool fastly_compute_at_edge_http_body_read(fastly_compute_at_edge_http_body_body_handle_t h, uint32_t chunk_size, fastly_compute_at_edge_cache_list_u8_t *ret, fastly_compute_at_edge_http_body_error_t *err);
extern bool fastly_compute_at_edge_http_body_write(fastly_compute_at_edge_http_body_body_handle_t h, fastly_compute_at_edge_cache_list_u8_t *buf, fastly_compute_at_edge_http_body_write_end_t end, uint32_t *ret, fastly_compute_at_edge_http_body_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_downstream_client_ip_addr(fastly_compute_at_edge_cache_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_downstream_client_h2_fingerprint(fastly_compute_at_edge_cache_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_downstream_tls_client_hello(fastly_compute_at_edge_cache_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_tls_raw_client_certificate(fastly_compute_at_edge_cache_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_downstream_tls_ja3_md5(fastly_compute_at_edge_cache_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_header_names_get(fastly_compute_at_edge_http_req_request_handle_t h, fastly_compute_at_edge_http_req_list_string_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_original_header_names_get(fastly_compute_at_edge_http_req_list_string_t *ret, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_header_value_get(fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name, fastly_compute_at_edge_http_req_option_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_values_get(fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name, fastly_compute_at_edge_http_req_option_list_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_values_set(fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name, fastly_compute_at_edge_http_req_list_string_t *values, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_insert(fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name, fastly_world_string_t *value, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_append(fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name, fastly_world_string_t *value, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_pending_req_poll(fastly_compute_at_edge_http_req_pending_request_handle_t h, fastly_compute_at_edge_http_req_option_response_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_pending_req_poll_v2(fastly_compute_at_edge_http_req_pending_request_handle_t h, fastly_compute_at_edge_http_req_send_error_detail_t *s, fastly_compute_at_edge_http_req_option_response_t *ret, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_pending_req_select(fastly_compute_at_edge_http_req_list_pending_request_handle_t *h, fastly_compute_at_edge_http_req_tuple2_u32_response_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_pending_req_select_v2(fastly_compute_at_edge_http_req_list_pending_request_handle_t *h, fastly_compute_at_edge_http_req_tuple2_u32_response_t *ret, fastly_compute_at_edge_http_req_send_error_detail_t *err);
...
extern bool fastly_compute_at_edge_http_resp_header_names_get(fastly_compute_at_edge_http_resp_response_handle_t h, fastly_compute_at_edge_http_req_list_string_t *ret, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_value_get(fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name, fastly_compute_at_edge_http_types_option_string_t *ret, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_values_get(fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name, fastly_compute_at_edge_http_req_option_list_list_u8_t *ret, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_values_set(fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name, fastly_compute_at_edge_http_req_list_string_t *values, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_insert(fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name, fastly_world_string_t *value, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_append(fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name, fastly_world_string_t *value, fastly_compute_at_edge_http_resp_error_t *err);
...
extern bool fastly_compute_at_edge_object_store_lookup(fastly_compute_at_edge_object_store_handle_t store, fastly_world_string_t *key, fastly_compute_at_edge_object_store_option_body_handle_t *ret, fastly_compute_at_edge_object_store_error_t *err);
...
extern bool fastly_compute_at_edge_object_store_pending_lookup_wait(fastly_compute_at_edge_object_store_pending_handle_t handle, fastly_compute_at_edge_object_store_option_body_handle_t *ret, fastly_compute_at_edge_object_store_error_t *err);
...
//    */
extern bool fastly_compute_at_edge_purge_surrogate_key(fastly_world_string_t *surrogate_keys, fastly_compute_at_edge_purge_options_mask_t purge_options, fastly_compute_at_edge_http_types_option_string_t *ret, fastly_compute_at_edge_purge_error_t *err);
...
extern bool fastly_compute_at_edge_secret_store_get(fastly_compute_at_edge_secret_store_store_handle_t store, fastly_world_string_t *key, fastly_compute_at_edge_secret_store_option_secret_handle_t *ret, fastly_compute_at_edge_secret_store_error_t *err);
extern bool fastly_compute_at_edge_secret_store_plaintext(fastly_compute_at_edge_secret_store_secret_handle_t secret, fastly_compute_at_edge_http_types_option_string_t *ret, fastly_compute_at_edge_secret_store_error_t *err);
extern bool fastly_compute_at_edge_secret_store_from_bytes(fastly_world_string_t *bytes, fastly_compute_at_edge_secret_store_secret_handle_t *ret, fastly_compute_at_edge_secret_store_error_t *err);
