...
} fastly_result_cache_handle_error_t;

typedef struct {
  bool is_err;
  union {
    fastly_tuple2_body_handle_cache_handle_t ok;
    fastly_error_t err;
  } val;
} fastly_result_tuple2_body_handle_cache_handle_error_t;
...
} fastly_result_cache_lookup_state_error_t;
...
__attribute__((import_module("fastly"), import_name("transaction-insert")))
void __wasm_import_fastly_transaction_insert(int32_t, int64_t, int32_t, int32_t, int32_t, int64_t, int64_t, int32_t, int32_t, int64_t, int32_t, int32_t, int32_t, int32_t);
...
__attribute__((import_module("fastly"), import_name("transaction-update")))
void __wasm_import_fastly_transaction_update(int32_t, int64_t, int32_t, int32_t, int32_t, int64_t, int64_t, int32_t, int32_t, int64_t, int32_t, int32_t, int32_t, int32_t);
...
__attribute__((import_module("fastly"), import_name("cache-close")))
void __wasm_import_fastly_cache_close(int32_t, int32_t);

__attribute__((import_module("fastly"), import_name("cache-get-state")))
void __wasm_import_fastly_cache_get_state(int32_t, int32_t);

__attribute__((import_module("fastly"), import_name("cache-get-user-metadata")))
void __wasm_import_fastly_cache_get_user_metadata(int32_t, int32_t, int32_t);
...
__attribute__((import_module("fastly"), import_name("cache-get-length")))
void __wasm_import_fastly_cache_get_length(int32_t, int32_t);

__attribute__((import_module("fastly"), import_name("cache-get-max-age-ns")))
void __wasm_import_fastly_cache_get_max_age_ns(int32_t, int32_t);

__attribute__((import_module("fastly"), import_name("cache-get-stale-while-revalidate-ns")))
void __wasm_import_fastly_cache_get_stale_while_revalidate_ns(int32_t, int32_t);

__attribute__((import_module("fastly"), import_name("cache-get-age-ns")))
void __wasm_import_fastly_cache_get_age_ns(int32_t, int32_t);

__attribute__((import_module("fastly"), import_name("cache-get-hits")))
void __wasm_import_fastly_cache_get_hits(int32_t, int32_t);
...
bool fastly_purge_surrogate_key(fastly_world_string_t *surrogate_key, fastly_purge_options_mask_t purge_options, fastly_option_string_t *ret, fastly_error_t *err) {
  __attribute__((aligned(4)))
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_purge_surrogate_key((int32_t) (*surrogate_key).ptr, (int32_t) (*surrogate_key).len, purge_options, ptr);
  fastly_result_option_string_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_lookup(fastly_world_string_t *cache_key, fastly_cache_lookup_options_t *options, fastly_cache_handle_t *ret, fastly_error_t *err) {
  ...
  fastly_result_cache_handle_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (uint32_t) (*((int32_t*) (ptr + 4)));
...
bool fastly_transaction_insert_and_stream_back(fastly_cache_handle_t handle, fastly_cache_write_options_t *options, fastly_tuple2_body_handle_cache_handle_t *ret, fastly_error_t *err) {
  __attribute__((aligned(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
  ...
  fastly_result_tuple2_body_handle_cache_handle_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (fastly_tuple2_body_handle_cache_handle_t) {
        (uint32_t) (*((int32_t*) (ptr + 4))),
        (uint32_t) (*((int32_t*) (ptr + 8))),
      };
      break;
...
bool fastly_transaction_update(fastly_cache_handle_t handle, fastly_cache_write_options_t *options, fastly_error_t *err) {
  __attribute__((aligned(1)))
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_transaction_update((int32_t) (handle), (int64_t) ((*options).max_age_ns), (int32_t) ((*options).request_headers), (int32_t) ((*options).vary_rule).ptr, (int32_t) ((*options).vary_rule).len, (int64_t) ((*options).initial_age_ns), (int64_t) ((*options).stale_while_revalidate_ns), (int32_t) ((*options).surrogate_keys).ptr, (int32_t) ((*options).surrogate_keys).len, (int64_t) ((*options).length), (int32_t) ((*options).user_metadata).ptr, (int32_t) ((*options).user_metadata).len, (*options).sensitive_data, ptr);
  fastly_result_void_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_close(fastly_cache_handle_t handle, fastly_error_t *err) {
  ...
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_cache_close((int32_t) (handle), ptr);
  fastly_result_void_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_get_state(fastly_cache_handle_t handle, fastly_cache_lookup_state_t *ret, fastly_error_t *err) {
  ...
  fastly_result_cache_lookup_state_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (int32_t) (*((uint8_t*) (ptr + 1)));
...
bool fastly_cache_get_user_metadata(fastly_cache_handle_t h, uint32_t chunk_size, fastly_list_u8_t *ret, fastly_error_t *err) {
  __attribute__((aligned(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_cache_get_user_metadata((int32_t) (h), (int32_t) (chunk_size), ptr);
  fastly_result_list_u8_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_get_length(fastly_cache_handle_t handle, uint64_t *ret, fastly_error_t *err) {
  ...
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_cache_get_length((int32_t) (handle), ptr);
  fastly_result_u64_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_get_max_age_ns(fastly_cache_handle_t handle, uint64_t *ret, fastly_error_t *err) {
  ...
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_cache_get_max_age_ns((int32_t) (handle), ptr);
  fastly_result_u64_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_get_stale_while_revalidate_ns(fastly_cache_handle_t handle, uint64_t *ret, fastly_error_t *err) {
  __attribute__((aligned(8)))
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_cache_get_stale_while_revalidate_ns((int32_t) (handle), ptr);
  fastly_result_u64_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_get_age_ns(fastly_cache_handle_t handle, uint64_t *ret, fastly_error_t *err) {
  ...
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_cache_get_age_ns((int32_t) (handle), ptr);
  fastly_result_u64_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
...
bool fastly_cache_get_hits(fastly_cache_handle_t handle, uint64_t *ret, fastly_error_t *err) {
  ...
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_fastly_cache_get_hits((int32_t) (handle), ptr);
  fastly_result_u64_error_t result;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
