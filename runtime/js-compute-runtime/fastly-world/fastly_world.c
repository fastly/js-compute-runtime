...
bool fastly_purge_surrogate_key(fastly_world_string_t *surrogate_keys, fastly_purge_options_mask_t purge_options, fastly_option_string_t *ret, fastly_error_t *err) {
  __attribute__((aligned(4)))
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
