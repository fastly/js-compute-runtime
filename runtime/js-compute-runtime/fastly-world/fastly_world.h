...
} fastly_world_option_fastly_compute_at_edge_fastly_body_handle_t;

typedef struct {
  bool is_some;
  fastly_compute_at_edge_fastly_fd_t val;
} fastly_world_option_fastly_compute_at_edge_fastly_fd_t;

typedef struct {
  bool is_some;
  fastly_compute_at_edge_fastly_secret_handle_t val;
} fastly_world_option_fastly_compute_at_edge_fastly_secret_handle_t;
...
bool fastly_compute_at_edge_fastly_abi_init(uint64_t abi_version,
                                            fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_uap_parse(fastly_world_string_t *user_agent,
                                             fastly_compute_at_edge_fastly_user_agent_t *ret,
                                             fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_body_append(
    ...
    fastly_compute_at_edge_fastly_body_handle_t src, fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_req_downstream_client_h2_fingerprint(
    fastly_world_list_u8_t *ret, fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_req_downstream_tls_raw_client_certificate(
    fastly_world_list_u8_t *ret, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_downstream_tls_client_cert_verify_result(
    fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_req_header_names_get(
    ...
    fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_header_value_get(
...
bool fastly_compute_at_edge_fastly_http_req_header_values_set(
    fastly_compute_at_edge_fastly_request_handle_t h, fastly_world_string_t *name,
    fastly_world_list_string_t *values, fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_req_version_set(
    fastly_compute_at_edge_fastly_request_handle_t h,
    fastly_compute_at_edge_fastly_http_version_t version,
    fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_send(fastly_compute_at_edge_fastly_request_handle_t h,
                                                 fastly_compute_at_edge_fastly_body_handle_t b,
...
bool fastly_compute_at_edge_fastly_http_req_send_async_streaming(
    ...
    fastly_world_string_t *backend, fastly_compute_at_edge_fastly_pending_request_handle_t *ret,
    fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_pending_req_poll(
...
bool fastly_compute_at_edge_fastly_http_req_pending_req_select(
    fastly_world_list_fastly_compute_at_edge_fastly_pending_request_handle_t *h,
    fastly_world_tuple2_u32_fastly_compute_at_edge_fastly_response_t *ret,
    fastly_compute_at_edge_fastly_error_t *err);
...
// service.
bool fastly_compute_at_edge_fastly_http_req_key_is_valid(
    bool *ret, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_close(fastly_compute_at_edge_fastly_request_handle_t h,
                                                  fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_auto_decompress_response_set(
    fastly_compute_at_edge_fastly_request_handle_t h,
    fastly_compute_at_edge_fastly_content_encodings_t encodings,
    fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_upgrade_websocket(
    fastly_world_string_t *backend, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_redirect_to_websocket_proxy(
    fastly_world_string_t *backend, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_redirect_to_grip_proxy(
    fastly_world_string_t *backend, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_req_framing_headers_mode_set(
    fastly_compute_at_edge_fastly_request_handle_t h,
    fastly_compute_at_edge_fastly_framing_headers_mode_t mode,
    fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_resp_header_names_get(
    ...
    fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_resp_header_value_get(
...
bool fastly_compute_at_edge_fastly_http_resp_header_values_get(
    fastly_compute_at_edge_fastly_response_handle_t h, fastly_world_string_t *name,
    fastly_world_option_list_string_t *ret, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_resp_header_values_set(
    fastly_compute_at_edge_fastly_response_handle_t h, fastly_world_string_t *name,
    fastly_world_list_string_t *values, fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_resp_version_get(
    ...
    fastly_compute_at_edge_fastly_http_version_t *ret, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_resp_version_set(
    fastly_compute_at_edge_fastly_response_handle_t h,
    fastly_compute_at_edge_fastly_http_version_t version,
    fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_http_resp_status_set(
    fastly_compute_at_edge_fastly_response_handle_t h,
    fastly_compute_at_edge_fastly_http_status_t status, fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_http_resp_close(
    fastly_compute_at_edge_fastly_response_handle_t h, fastly_compute_at_edge_fastly_error_t *err);
// Adjust how this response's framing headers are determined.
bool fastly_compute_at_edge_fastly_http_resp_framing_headers_mode_set(
    fastly_compute_at_edge_fastly_response_handle_t h,
    fastly_compute_at_edge_fastly_framing_headers_mode_t mode,
    fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_object_store_lookup(
    ...
    fastly_compute_at_edge_fastly_error_t *err);
bool fastly_compute_at_edge_fastly_object_store_lookup_as_fd(
    fastly_compute_at_edge_fastly_object_store_handle_t store, fastly_world_string_t *key,
    fastly_world_option_fastly_compute_at_edge_fastly_fd_t *ret,
    fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_secret_store_plaintext(
    fastly_compute_at_edge_fastly_secret_handle_t secret, fastly_world_option_string_t *ret,
    fastly_compute_at_edge_fastly_error_t *err);
...
bool fastly_compute_at_edge_fastly_purge_surrogate_key(
    fastly_world_string_t *surrogate_keys,
    fastly_compute_at_edge_fastly_purge_options_mask_t purge_options,
    fastly_world_option_string_t *ret, fastly_compute_at_edge_fastly_error_t *err);
