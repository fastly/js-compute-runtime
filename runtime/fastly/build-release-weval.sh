...
mv build-release-weval/starling.wasm/starling.wasm ../../fastly-weval.wasm
mv build-release-weval/starling.wasm/starling-ics.wevalcache ../../fastly-ics.wevalcache
