...
// large.
#define FASTLY_COMPUTE_AT_EDGE_HTTP_TYPES_SEND_ERROR_DETAIL_TAG_HTTP_RESPONSE_HEADER_SECTION_TOO_LARGE \
  14
...
typedef fastly_compute_at_edge_http_types_tls_version_t
    fastly_compute_at_edge_backend_tls_version_t;
...
typedef fastly_compute_at_edge_http_types_request_handle_t
...
typedef fastly_compute_at_edge_http_types_http_version_t
    fastly_compute_at_edge_http_req_http_version_t;

typedef fastly_compute_at_edge_http_types_response_t fastly_compute_at_edge_http_req_response_t;

typedef fastly_compute_at_edge_http_types_pending_request_handle_t
    fastly_compute_at_edge_http_req_pending_request_handle_t;

typedef fastly_compute_at_edge_http_types_content_encodings_t
    fastly_compute_at_edge_http_req_content_encodings_t;

typedef fastly_compute_at_edge_http_types_framing_headers_mode_t
    fastly_compute_at_edge_http_req_framing_headers_mode_t;

typedef fastly_compute_at_edge_http_types_dynamic_backend_config_t
    fastly_compute_at_edge_http_req_dynamic_backend_config_t;

typedef fastly_compute_at_edge_http_types_send_error_detail_t
    fastly_compute_at_edge_http_req_send_error_detail_t;
...
typedef fastly_compute_at_edge_http_types_response_handle_t
...
typedef fastly_compute_at_edge_http_types_http_version_t
    fastly_compute_at_edge_http_resp_http_version_t;

typedef fastly_compute_at_edge_http_types_http_status_t
    fastly_compute_at_edge_http_resp_http_status_t;

typedef fastly_compute_at_edge_http_types_framing_headers_mode_t
    fastly_compute_at_edge_http_resp_framing_headers_mode_t;
...
extern bool fastly_compute_at_edge_async_io_select(fastly_world_list_handle_t *hs,
                                                   uint32_t timeout_ms,
...
// type.
extern bool
fastly_compute_at_edge_async_io_is_ready(fastly_compute_at_edge_async_io_handle_t handle, bool *ret,
                                         fastly_compute_at_edge_async_io_error_t *err);

// Imported Functions from `fastly:compute-at-edge/backend`
extern bool fastly_compute_at_edge_backend_exists(fastly_world_string_t *backend, bool *ret,
                                                  fastly_compute_at_edge_backend_error_t *err);
extern bool
fastly_compute_at_edge_backend_is_healthy(fastly_world_string_t *backend,
                                          fastly_compute_at_edge_backend_backend_health_t *ret,
                                          fastly_compute_at_edge_backend_error_t *err);
// Returns `true` if the backend is a "dynamic" backend.
extern bool fastly_compute_at_edge_backend_is_dynamic(fastly_world_string_t *backend, bool *ret,
                                                      fastly_compute_at_edge_backend_error_t *err);
// Get the host of this backend.
extern bool fastly_compute_at_edge_backend_get_host(fastly_world_string_t *backend,
...
// Fastly documentation oh this topic here:
// https://docs.fastly.com/en/guides/specifying-an-override-host
extern bool
fastly_compute_at_edge_backend_get_override_host(fastly_world_string_t *backend,
                                                 fastly_world_option_string_t *ret,
                                                 fastly_compute_at_edge_backend_error_t *err);
// Get the remote TCP port of the backend connection for the request.
extern bool fastly_compute_at_edge_backend_get_port(fastly_world_string_t *backend, uint16_t *ret,
                                                    fastly_compute_at_edge_backend_error_t *err);
// Get the connection timeout of the backend.
extern bool
fastly_compute_at_edge_backend_get_connect_timeout_ms(fastly_world_string_t *backend, uint32_t *ret,
                                                      fastly_compute_at_edge_backend_error_t *err);
// Get the first byte timeout of the backend.
extern bool fastly_compute_at_edge_backend_get_first_byte_timeout_ms(
    fastly_world_string_t *backend, uint32_t *ret, fastly_compute_at_edge_backend_error_t *err);
// Get the between byte timeout of the backend.
extern bool fastly_compute_at_edge_backend_get_between_bytes_timeout_ms(
    fastly_world_string_t *backend, uint32_t *ret, fastly_compute_at_edge_backend_error_t *err);
// Returns `true` if the backend is configured to use SSL.
extern bool fastly_compute_at_edge_backend_is_ssl(fastly_world_string_t *backend, bool *ret,
                                                  fastly_compute_at_edge_backend_error_t *err);
// Get the minimum SSL version this backend will use.
extern bool fastly_compute_at_edge_backend_get_ssl_min_version(
    fastly_world_string_t *backend, fastly_compute_at_edge_backend_tls_version_t *ret,
    fastly_compute_at_edge_backend_error_t *err);
...
extern bool fastly_compute_at_edge_cache_lookup(
    fastly_world_string_t *key, fastly_compute_at_edge_cache_lookup_options_t *options,
    fastly_compute_at_edge_cache_handle_t *ret, fastly_compute_at_edge_cache_error_t *err);
...
// the cache.
extern bool fastly_compute_at_edge_cache_insert(
    fastly_world_string_t *key, fastly_compute_at_edge_cache_write_options_t *options,
...
extern bool fastly_compute_at_edge_cache_transaction_lookup(
    fastly_world_string_t *key, fastly_compute_at_edge_cache_lookup_options_t *options,
    fastly_compute_at_edge_cache_handle_t *ret, fastly_compute_at_edge_cache_error_t *err);
...
// The returned handle is to a streaming body that is used for writing the object into
// the cache.
extern bool fastly_compute_at_edge_cache_transaction_insert(
...
extern bool fastly_compute_at_edge_cache_transaction_insert_and_stream_back(
    fastly_compute_at_edge_cache_handle_t handle,
    fastly_compute_at_edge_cache_write_options_t *options,
    fastly_world_tuple2_body_handle_handle_t *ret, fastly_compute_at_edge_cache_error_t *err);
...
extern bool
fastly_compute_at_edge_cache_transaction_cancel(fastly_compute_at_edge_cache_handle_t handle,
                                                fastly_compute_at_edge_cache_error_t *err);
...
extern bool fastly_compute_at_edge_cache_close(fastly_compute_at_edge_cache_handle_t handle,
                                               fastly_compute_at_edge_cache_error_t *err);
extern bool fastly_compute_at_edge_cache_get_state(fastly_compute_at_edge_cache_handle_t handle,
                                                   fastly_compute_at_edge_cache_lookup_state_t *ret,
                                                   fastly_compute_at_edge_cache_error_t *err);
// Gets the user metadata of the found object, returning `none` if there
// was no found object.
extern bool
fastly_compute_at_edge_cache_get_user_metadata(fastly_compute_at_edge_cache_handle_t handle,
...
extern bool fastly_compute_at_edge_cache_get_body(
    fastly_compute_at_edge_cache_handle_t handle,
...
extern bool fastly_compute_at_edge_cache_get_length(fastly_compute_at_edge_cache_handle_t handle,
                                                    uint64_t *ret,
                                                    fastly_compute_at_edge_cache_error_t *err);
// Gets the configured max age of the found object, returning the `$none` error if there
// was no found object.
extern bool
fastly_compute_at_edge_cache_get_max_age_ns(fastly_compute_at_edge_cache_handle_t handle,
                                            uint64_t *ret,
                                            fastly_compute_at_edge_cache_error_t *err);
...
extern bool fastly_compute_at_edge_cache_get_stale_while_revalidate_ns(
...
// was no found object.
extern bool fastly_compute_at_edge_cache_get_age_ns(fastly_compute_at_edge_cache_handle_t handle,
                                                    uint64_t *ret,
                                                    fastly_compute_at_edge_cache_error_t *err);
// Gets the number of cache hits for the found object, returning the `$none` error if there
// was no found object.
extern bool fastly_compute_at_edge_cache_get_hits(fastly_compute_at_edge_cache_handle_t handle,
                                                  uint64_t *ret,
                                                  fastly_compute_at_edge_cache_error_t *err);
...
extern bool fastly_compute_at_edge_dictionary_open(fastly_world_string_t *name,
                                                   fastly_compute_at_edge_dictionary_handle_t *ret,
                                                   fastly_compute_at_edge_dictionary_error_t *err);
extern bool fastly_compute_at_edge_dictionary_get(fastly_compute_at_edge_dictionary_handle_t h,
...
extern bool fastly_compute_at_edge_edge_rate_limiter_ratecounter_increment(
    fastly_world_string_t *rate_counter_name, fastly_world_string_t *entry, uint32_t delta,
    fastly_compute_at_edge_edge_rate_limiter_error_t *err);
extern bool fastly_compute_at_edge_edge_rate_limiter_ratecounter_lookup_rate(
...
extern bool fastly_compute_at_edge_edge_rate_limiter_ratecounter_lookup_count(
    fastly_world_string_t *rate_counter_name, fastly_world_string_t *entry, uint32_t duration,
    uint32_t *ret, fastly_compute_at_edge_edge_rate_limiter_error_t *err);
extern bool fastly_compute_at_edge_edge_rate_limiter_penaltybox_add(
    fastly_world_string_t *penalty_box_name, fastly_world_string_t *entry, uint32_t time_to_live,
    fastly_compute_at_edge_edge_rate_limiter_error_t *err);
extern bool fastly_compute_at_edge_edge_rate_limiter_penaltybox_has(
...
// JSON string for now
extern bool fastly_compute_at_edge_geo_lookup(fastly_world_list_u8_t *addr_octets,
                                              fastly_world_string_t *ret,
                                              fastly_compute_at_edge_geo_error_t *err);

// Imported Functions from `fastly:compute-at-edge/http-body`
extern bool
fastly_compute_at_edge_http_body_append(fastly_compute_at_edge_http_body_body_handle_t dest,
                                        fastly_compute_at_edge_http_body_body_handle_t src,
                                        fastly_compute_at_edge_http_body_error_t *err);
extern bool
fastly_compute_at_edge_http_body_new(fastly_compute_at_edge_http_body_body_handle_t *ret,
                                     fastly_compute_at_edge_http_body_error_t *err);
extern bool fastly_compute_at_edge_http_body_read(fastly_compute_at_edge_http_body_body_handle_t h,
                                                  uint32_t chunk_size, fastly_world_list_u8_t *ret,
                                                  fastly_compute_at_edge_http_body_error_t *err);
extern bool fastly_compute_at_edge_http_body_write(fastly_compute_at_edge_http_body_body_handle_t h,
                                                   fastly_world_list_u8_t *buf,
                                                   fastly_compute_at_edge_http_body_write_end_t end,
                                                   uint32_t *ret,
                                                   fastly_compute_at_edge_http_body_error_t *err);
extern bool fastly_compute_at_edge_http_body_close(fastly_compute_at_edge_http_body_body_handle_t h,
                                                   fastly_compute_at_edge_http_body_error_t *err);

// Imported Functions from `fastly:compute-at-edge/http-req`
extern bool fastly_compute_at_edge_http_req_cache_override_set(
    ...
    fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_client_ip_addr(
    fastly_world_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_server_ip_addr(
    fastly_world_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_client_request_id(
    fastly_world_string_t *ret, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_downstream_tls_protocol(
    fastly_world_string_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_tls_client_hello(
    fastly_world_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_tls_raw_client_certificate(
    fastly_world_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_tls_client_cert_verify_result(
    fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_downstream_tls_ja3_md5(
    fastly_world_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_new(fastly_compute_at_edge_http_req_request_handle_t *ret,
                                    fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_header_names_get(fastly_compute_at_edge_http_req_request_handle_t h,
                                                 fastly_world_list_string_t *ret,
                                                 fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_original_header_names_get(
    fastly_world_list_string_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_original_header_count(uint32_t *ret,
                                                      fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_value_get(
    fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name,
    fastly_world_option_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_values_get(
    fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name,
    fastly_world_option_list_list_u8_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_values_set(
    fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name,
    fastly_world_list_list_u8_t *values, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_insert(
    fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name,
    fastly_world_list_u8_t *value, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_header_append(
    fastly_compute_at_edge_http_req_request_handle_t h, fastly_world_string_t *name,
    fastly_world_list_u8_t *value, fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_header_remove(fastly_compute_at_edge_http_req_request_handle_t h,
                                              fastly_world_string_t *name,
                                              fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_method_get(fastly_compute_at_edge_http_req_request_handle_t h,
                                           fastly_world_string_t *ret,
                                           fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_method_set(fastly_compute_at_edge_http_req_request_handle_t h,
                                           fastly_world_string_t *method,
                                           fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_uri_get(fastly_compute_at_edge_http_req_request_handle_t h,
                                        fastly_world_string_t *ret,
                                        fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_uri_set(fastly_compute_at_edge_http_req_request_handle_t h,
                                        fastly_world_string_t *uri,
                                        fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_version_get(fastly_compute_at_edge_http_req_request_handle_t h,
                                            fastly_compute_at_edge_http_req_http_version_t *ret,
                                            fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_version_set(fastly_compute_at_edge_http_req_request_handle_t h,
                                            fastly_compute_at_edge_http_req_http_version_t version,
                                            fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_send(fastly_compute_at_edge_http_req_request_handle_t h,
                                                 fastly_compute_at_edge_http_req_body_handle_t b,
                                                 fastly_world_string_t *backend,
                                                 fastly_compute_at_edge_http_req_response_t *ret,
                                                 fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_send_v2(
    fastly_compute_at_edge_http_req_request_handle_t h,
    fastly_compute_at_edge_http_req_send_error_detail_t *s,
    fastly_compute_at_edge_http_req_body_handle_t b, fastly_world_string_t *backend,
    fastly_compute_at_edge_http_req_response_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_send_async(
    fastly_compute_at_edge_http_req_request_handle_t h,
    fastly_compute_at_edge_http_req_body_handle_t b, fastly_world_string_t *backend,
    fastly_compute_at_edge_http_req_pending_request_handle_t *ret,
    fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_send_async_streaming(
    fastly_compute_at_edge_http_req_request_handle_t h,
    fastly_compute_at_edge_http_req_body_handle_t b, fastly_world_string_t *backend,
    fastly_compute_at_edge_http_req_pending_request_handle_t *ret,
    fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_pending_req_poll(
    fastly_compute_at_edge_http_req_pending_request_handle_t h, fastly_world_option_response_t *ret,
    fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_pending_req_poll_v2(
    fastly_compute_at_edge_http_req_pending_request_handle_t h,
    fastly_compute_at_edge_http_req_send_error_detail_t *s, fastly_world_option_response_t *ret,
    fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_pending_req_wait(
    fastly_compute_at_edge_http_req_pending_request_handle_t h,
    fastly_compute_at_edge_http_req_response_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_pending_req_wait_v2(
    fastly_compute_at_edge_http_req_pending_request_handle_t h,
    fastly_compute_at_edge_http_req_send_error_detail_t *s,
    fastly_compute_at_edge_http_req_response_t *ret, fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_pending_req_select(fastly_world_list_pending_request_handle_t *h,
                                                   fastly_world_tuple2_u32_response_t *ret,
                                                   fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_pending_req_select_v2(
    fastly_world_list_pending_request_handle_t *h, fastly_world_tuple2_u32_response_t *ret,
    fastly_compute_at_edge_http_req_send_error_detail_t *err);
extern bool
fastly_compute_at_edge_http_req_close(fastly_compute_at_edge_http_req_request_handle_t h,
                                      fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_auto_decompress_response_set(
    fastly_compute_at_edge_http_req_request_handle_t h,
    fastly_compute_at_edge_http_req_content_encodings_t encodings,
    fastly_compute_at_edge_http_req_error_t *err);
extern bool
fastly_compute_at_edge_http_req_upgrade_websocket(fastly_world_string_t *backend,
                                                  fastly_compute_at_edge_http_req_error_t *err);
extern bool fastly_compute_at_edge_http_req_redirect_to_websocket_proxy(
    fastly_world_string_t *backend, fastly_compute_at_edge_http_req_error_t *err);
...
extern bool fastly_compute_at_edge_http_req_register_dynamic_backend(
    ...
    fastly_compute_at_edge_http_req_dynamic_backend_config_t *config,
    fastly_compute_at_edge_http_req_error_t *err);

// Imported Functions from `fastly:compute-at-edge/http-resp`
extern bool
fastly_compute_at_edge_http_resp_new(fastly_compute_at_edge_http_resp_response_handle_t *ret,
                                     fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_names_get(
    fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_list_string_t *ret,
    fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_value_get(
    fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name,
    fastly_world_option_string_t *ret, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_values_get(
    fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name,
    fastly_world_option_list_list_u8_t *ret, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_values_set(
    fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name,
    fastly_world_list_list_u8_t *values, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_insert(
    fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name,
    fastly_world_list_u8_t *value, fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_header_append(
    fastly_compute_at_edge_http_resp_response_handle_t h, fastly_world_string_t *name,
    fastly_world_list_u8_t *value, fastly_compute_at_edge_http_resp_error_t *err);
extern bool
fastly_compute_at_edge_http_resp_header_remove(fastly_compute_at_edge_http_resp_response_handle_t h,
                                               fastly_world_string_t *name,
                                               fastly_compute_at_edge_http_resp_error_t *err);
extern bool
fastly_compute_at_edge_http_resp_version_get(fastly_compute_at_edge_http_resp_response_handle_t h,
                                             fastly_compute_at_edge_http_resp_http_version_t *ret,
                                             fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_version_set(
    fastly_compute_at_edge_http_resp_response_handle_t h,
    fastly_compute_at_edge_http_resp_http_version_t version,
    fastly_compute_at_edge_http_resp_error_t *err);
extern bool fastly_compute_at_edge_http_resp_send_downstream(
    fastly_compute_at_edge_http_resp_response_handle_t h,
    fastly_compute_at_edge_http_resp_body_handle_t b, bool streaming,
    fastly_compute_at_edge_http_resp_error_t *err);
extern bool
fastly_compute_at_edge_http_resp_status_get(fastly_compute_at_edge_http_resp_response_handle_t h,
                                            fastly_compute_at_edge_http_resp_http_status_t *ret,
                                            fastly_compute_at_edge_http_resp_error_t *err);
extern bool
fastly_compute_at_edge_http_resp_status_set(fastly_compute_at_edge_http_resp_response_handle_t h,
                                            fastly_compute_at_edge_http_resp_http_status_t status,
                                            fastly_compute_at_edge_http_resp_error_t *err);
extern bool
...
extern bool fastly_compute_at_edge_http_resp_http_keepalive_mode_set(
    fastly_compute_at_edge_http_resp_response_handle_t h,
    fastly_compute_at_edge_http_resp_keepalive_mode_t mode,
    fastly_compute_at_edge_http_resp_error_t *err);

// Imported Functions from `fastly:compute-at-edge/log`
extern bool fastly_compute_at_edge_log_endpoint_get(fastly_world_string_t *name,
                                                    fastly_compute_at_edge_log_handle_t *ret,
                                                    fastly_compute_at_edge_log_error_t *err);
extern bool fastly_compute_at_edge_log_write(fastly_compute_at_edge_log_handle_t h,
                                             fastly_world_string_t *msg,
                                             fastly_compute_at_edge_log_error_t *err);

// Imported Functions from `fastly:compute-at-edge/object-store`
extern bool
fastly_compute_at_edge_object_store_open(fastly_world_string_t *name,
                                         fastly_compute_at_edge_object_store_handle_t *ret,
                                         fastly_compute_at_edge_object_store_error_t *err);
extern bool fastly_compute_at_edge_object_store_lookup(
    fastly_compute_at_edge_object_store_handle_t store, fastly_world_string_t *key,
    fastly_world_option_body_handle_t *ret, fastly_compute_at_edge_object_store_error_t *err);
extern bool fastly_compute_at_edge_object_store_lookup_async(
    fastly_compute_at_edge_object_store_handle_t store, fastly_world_string_t *key,
    fastly_compute_at_edge_object_store_pending_handle_t *ret,
    fastly_compute_at_edge_object_store_error_t *err);
extern bool fastly_compute_at_edge_object_store_pending_lookup_wait(
    fastly_compute_at_edge_object_store_pending_handle_t handle,
    fastly_world_option_body_handle_t *ret, fastly_compute_at_edge_object_store_error_t *err);
extern bool fastly_compute_at_edge_object_store_delete_async(
    fastly_compute_at_edge_object_store_handle_t store, fastly_world_string_t *key,
    fastly_compute_at_edge_object_store_pending_handle_t *ret,
    fastly_compute_at_edge_object_store_error_t *err);
...
extern bool fastly_compute_at_edge_object_store_insert(
    fastly_compute_at_edge_object_store_handle_t store, fastly_world_string_t *key,
    fastly_compute_at_edge_object_store_body_handle_t body_handle,
    fastly_compute_at_edge_object_store_error_t *err);

// Imported Functions from `fastly:compute-at-edge/purge`
// *
//    * A surrogate key can be a max of 1024 characters.
//    * A surrogate key must contain only printable ASCII characters (those between `0x21` and
//    `0x7E`, inclusive).
//    */
extern bool fastly_compute_at_edge_purge_surrogate_key(
    fastly_world_string_t *surrogate_keys,
    fastly_compute_at_edge_purge_options_mask_t purge_options, fastly_world_option_string_t *ret,
    fastly_compute_at_edge_purge_error_t *err);

// Imported Functions from `fastly:compute-at-edge/secret-store`
extern bool
fastly_compute_at_edge_secret_store_open(fastly_world_string_t *name,
...
extern bool fastly_compute_at_edge_uap_parse(fastly_world_string_t *user_agent,
                                             fastly_compute_at_edge_uap_user_agent_t *ret,
                                             fastly_compute_at_edge_uap_error_t *err);
