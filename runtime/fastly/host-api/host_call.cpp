...
static_assert(std::is_same_v<APIError, fastly_compute_at_edge_types_error_t>);

bool error_is_generic(APIError e) { return e == FASTLY_COMPUTE_AT_EDGE_TYPES_ERROR_GENERIC_ERROR; }
...
bool error_is_bad_handle(APIError e) { return e == FASTLY_COMPUTE_AT_EDGE_TYPES_ERROR_BAD_HANDLE; }
