#ifndef BUILTINS_WEB_FASTLY_CRYPTO_CRYPTO_KEY_H
#define BUILTINS_WEB_FASTLY_CRYPTO_CRYPTO_KEY_H
...
class CryptoKey : public builtins::BuiltinNoConstructor<CryptoKey> {
public:
