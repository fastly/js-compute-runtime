...
bool fastly_uap_parse(xqd_world_string_t *user_agent, fastly_user_agent_t *ret, fastly_error_t *err);
...
bool fastly_log_endpoint_get(xqd_world_string_t *name, fastly_log_endpoint_handle_t *ret, fastly_error_t *err);
...
bool fastly_http_req_cache_override_set(fastly_request_handle_t h, fastly_http_cache_override_tag_t tag, uint32_t *maybe_ttl, uint32_t *maybe_stale_while_revalidate, xqd_world_string_t *maybe_sk, fastly_error_t *err);
...
bool fastly_http_req_downstream_tls_cipher_openssl_name(xqd_world_string_t *ret, fastly_error_t *err);
...
bool fastly_http_req_header_value_get(fastly_request_handle_t h, xqd_world_string_t *name, fastly_option_string_t *ret, fastly_error_t *err);
bool fastly_http_req_header_values_get(fastly_request_handle_t h, xqd_world_string_t *name, fastly_option_list_string_t *ret, fastly_error_t *err);
bool fastly_http_req_header_values_set(fastly_request_handle_t h, xqd_world_string_t *name, fastly_list_string_t *values, fastly_error_t *err);
bool fastly_http_req_header_insert(fastly_request_handle_t h, xqd_world_string_t *name, xqd_world_string_t *value, fastly_error_t *err);
bool fastly_http_req_header_append(fastly_request_handle_t h, xqd_world_string_t *name, xqd_world_string_t *value, fastly_error_t *err);
bool fastly_http_req_header_remove(fastly_request_handle_t h, xqd_world_string_t *name, fastly_error_t *err);
bool fastly_http_req_method_get(fastly_request_handle_t h, xqd_world_string_t *ret, fastly_error_t *err);
bool fastly_http_req_method_set(fastly_request_handle_t h, xqd_world_string_t *method, fastly_error_t *err);
bool fastly_http_req_uri_get(fastly_request_handle_t h, xqd_world_string_t *ret, fastly_error_t *err);
bool fastly_http_req_uri_set(fastly_request_handle_t h, xqd_world_string_t *uri, fastly_error_t *err);
...
bool fastly_http_req_send(fastly_request_handle_t h, fastly_body_handle_t b, xqd_world_string_t *backend, fastly_response_t *ret, fastly_error_t *err);
bool fastly_http_req_send_async(fastly_request_handle_t h, fastly_body_handle_t b, xqd_world_string_t *backend, fastly_pending_request_handle_t *ret, fastly_error_t *err);
bool fastly_http_req_send_async_streaming(fastly_request_handle_t h, fastly_body_handle_t b, xqd_world_string_t *backend, fastly_pending_request_handle_t *ret, fastly_error_t *err);
...
bool fastly_http_req_register_dynamic_backend(xqd_world_string_t *prefix, xqd_world_string_t *target, fastly_dynamic_backend_config_t *config, fastly_error_t *err);
...
bool fastly_http_resp_header_value_get(fastly_response_handle_t h, xqd_world_string_t *name, fastly_option_string_t *ret, fastly_error_t *err);
bool fastly_http_resp_header_values_get(fastly_response_handle_t h, xqd_world_string_t *name, fastly_option_list_string_t *ret, fastly_error_t *err);
bool fastly_http_resp_header_values_set(fastly_response_handle_t h, xqd_world_string_t *name, fastly_list_string_t *values, fastly_error_t *err);
bool fastly_http_resp_header_insert(fastly_response_handle_t h, xqd_world_string_t *name, xqd_world_string_t *value, fastly_error_t *err);
bool fastly_http_resp_header_append(fastly_response_handle_t h, xqd_world_string_t *name, xqd_world_string_t *value, fastly_error_t *err);
bool fastly_http_resp_header_remove(fastly_response_handle_t h, xqd_world_string_t *name, fastly_error_t *err);
...
bool fastly_dictionary_open(xqd_world_string_t *name, fastly_dictionary_handle_t *ret, fastly_error_t *err);
bool fastly_dictionary_get(fastly_dictionary_handle_t h, xqd_world_string_t *key, fastly_option_string_t *ret, fastly_error_t *err);
bool fastly_geo_lookup(fastly_list_u8_t *addr_octets, xqd_world_string_t *ret, fastly_error_t *err);
bool fastly_object_store_open(xqd_world_string_t *name, fastly_object_store_handle_t *ret, fastly_error_t *err);
bool fastly_object_store_lookup(fastly_object_store_handle_t store, xqd_world_string_t *key, fastly_option_body_handle_t *ret, fastly_error_t *err);
bool fastly_object_store_lookup_as_fd(fastly_object_store_handle_t store, xqd_world_string_t *key, fastly_option_fd_t *ret, fastly_error_t *err);
bool fastly_object_store_insert(fastly_object_store_handle_t store, xqd_world_string_t *key, fastly_body_handle_t body_handle, fastly_error_t *err);
bool fastly_secret_store_open(xqd_world_string_t *name, fastly_secret_store_handle_t *ret, fastly_error_t *err);
bool fastly_secret_store_get(fastly_secret_store_handle_t store, xqd_world_string_t *key, fastly_option_secret_handle_t *ret, fastly_error_t *err);
...
bool fastly_purge_surrogate_key(xqd_world_string_t *surrogate_key, bool soft_purge, fastly_purge_result_t *ret, fastly_error_t *err);
