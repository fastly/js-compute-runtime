...
public:
  ...
  // TODO: We need to use mozilla::Vector instead of std::vector because std::vector can throw
  // exceptions and we compile without exceptions
  ...
  JsonWebKey(std::string kty, std::optional<std::string> use, std::vector<std::string> key_ops,
             ...
             std::optional<std::string> k)
      : kty{kty}, use{use}, key_ops{key_ops}, alg{alg}, ext{ext}, crv{crv}, x{x}, y{y}, n{n}, e{e},
        d{d}, p{p}, q{q}, dp{dp}, dq{dq}, qi{qi}, oth{oth}, k{k} {}
};
...
enum class CryptoKeyFormat { Raw, Spki, Pkcs8, Jwk };
...
public:
  ...
  static JS::Result<CryptoKeyUsageBitmap>
  toKeyUsageBitmap(JSContext *cx, JS::HandleValue key_usages, std::string_view error_message);
  ...
  static JSObject *importJwkRsa(JSContext *cx, CryptoAlgorithmRSA_OAEP_KeyImport *algorithm,
                                JsonWebKey *keyData, bool extractable, CryptoKeyUsageBitmap usages);
  static JSObject *createRSA(JSContext *cx, CryptoAlgorithmRSA_OAEP_KeyImport *algorithm,
                             CryptoKeyRSAComponents keyData, bool extractable,
                             CryptoKeyUsageBitmap usages);

  static JSObject *importJwkRsa(JSContext *cx, CryptoAlgorithmRSASSA_PKCS1_v1_5_Import *algorithm,
                                JsonWebKey *keyData, bool extractable, CryptoKeyUsageBitmap usages);
  ...
  static JSObject *create(JSContext *cx, CryptoAlgorithmRSA_OAEP_KeyImport *algorithm,
...
public:
  ...
  static std::unique_ptr<CryptoAlgorithmGenerateKey> normalize(JSContext *cx,
...
public:
  virtual JSObject *importKey(JSContext *cx, CryptoKeyFormat, JS::HandleValue, bool extractable,
                              CryptoKeyUsageBitmap) = 0;
  virtual JSObject *importKey(JSContext *cx, CryptoKeyFormat, KeyData, bool extractable,
                              CryptoKeyUsageBitmap) = 0;
...
public:
  ...
  static std::unique_ptr<CryptoAlgorithmWrapUnwrapkey> normalize(JSContext *cx,
                                                                 JS::HandleValue value);
};
...
public:
  ...
  static std::unique_ptr<CryptoAlgorithmGetKeyLength> normalize(JSContext *cx,
                                                                JS::HandleValue value);
};

class CryptoAlgorithmECDHKey final : public CryptoAlgorithmImportKey,
                                     public CryptoAlgorithmDeriveBits {
public:
  // A CryptoKey object representing the public key of the other entity.
  CryptoKey *publicKey;
  // The named curve that the key uses
  const char *namedCurve;
  const char *name() const noexcept override { return "ECDH"; };
  CryptoAlgorithmECDHKey(CryptoKey *publicKey, const char *namedCurve)
      : publicKey{publicKey}, namedCurve{namedCurve} {};
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::ECDH; };

  JSObject *deriveBits(JSContext *cx, CryptoKey, size_t length) override;
  JSObject *importKey(JSContext *cx, CryptoKeyFormat, JS::HandleValue, bool extractable,
                      CryptoKeyUsageBitmap) override;
  JSObject *importKey(JSContext *cx, CryptoKeyFormat, KeyData, bool extractable,
                      CryptoKeyUsageBitmap) override;
...
public:
  ...
  CryptoAlgorithmECDSASignVerify(CryptoAlgorithmIdentifier hashIdentifier)
      : hashIdentifier{hashIdentifier} {};
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::ECDSA; };
...
public:
  ...
  const char *name() const noexcept override { return "ECDSA"; };
  CryptoAlgorithmECDSAKey(CryptoAlgorithmIdentifier hashIdentifier, const char *namedCurve)
      : hashIdentifier{hashIdentifier}, namedCurve{namedCurve} {};
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::ECDSA; };
...
public:
  const char *name() const noexcept override { return "HKDF"; };
  CryptoAlgorithmHKDF(){};
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::HKDF; };

  size_t getKeyLength(JSContext *cx) override { return 0; };
  JSObject *toObject(JSContext *cx) override;
};
...
public:
  ...
  const char *name() const noexcept override { return "HKDF"; };
  CryptoAlgorithmHKDFDerive(CryptoAlgorithmIdentifier hashIdentifier, std::span<uint8_t> salt,
                            std::span<uint8_t> info)
      : hashIdentifier{hashIdentifier}, salt{salt}, info{info} {};
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::HKDF; };
...
class CryptoAlgorithmHMAC final : public CryptoAlgorithmSignVerify,
                                  public CryptoAlgorithmGenerateKey,
                                  public CryptoAlgorithmImportKey,
                                  public CryptoAlgorithmGetKeyLength {
public:
  ...
  CryptoAlgorithmHMAC(CryptoAlgorithmIdentifier hashIdentifier, size_t length)
      : hashIdentifier{hashIdentifier}, length{length} {};

  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::HMAC; };
...
public:
  const char *name() const noexcept override { return "PBKDF2"; };
  CryptoAlgorithmPBKDF2(){};
  CryptoAlgorithmIdentifier identifier() final { return CryptoAlgorithmIdentifier::PBKDF2; };

  size_t getKeyLength(JSContext *cx) override { return 0; };
  JSObject *toObject(JSContext *cx) override;
};

class CryptoAlgorithmPBKDF2Key final : public CryptoAlgorithmImportKey,
                                       public CryptoAlgorithmDeriveBits {
public:
  CryptoAlgorithmIdentifier hashIdentifier;
  std::span<uint8_t> salt;
  ...
  const char *name() const noexcept override { return "PBKDF2"; };
  CryptoAlgorithmPBKDF2Key(CryptoAlgorithmIdentifier hashIdentifier, std::span<uint8_t> salt,
                           unsigned long iterations)
      : hashIdentifier{hashIdentifier}, salt{salt}, iterations{iterations} {};
  CryptoAlgorithmIdentifier identifier() final { return CryptoAlgorithmIdentifier::PBKDF2; };
...
class CryptoAlgorithmRSAES_PKCS1_v1_5 final : public CryptoAlgorithmEncDec,
                                              public CryptoAlgorithmGenerateKey,
                                              public CryptoAlgorithmImportKey {
public:
  ...
  const char *name() const noexcept override { return "RSAES-PKCS1-v1_5"; };
  CryptoAlgorithmRSAES_PKCS1_v1_5(std::optional<size_t> modulusLength,
                                  std::optional<std::span<uint8_t>> publicExponent)
      : modulusLength{modulusLength}, publicExponent{publicExponent} {};
...
public:
  ...
  const char *name() const noexcept override { return "RSASSA-PKCS1-v1_5"; };
  CryptoAlgorithmRSASSA_PKCS1_v1_5_KeyGen(size_t modulusLength, std::span<uint8_t> publicExponent,
                                          CryptoAlgorithmIdentifier hashIdentifier)
      : modulusLength{modulusLength}, publicExponent{publicExponent}, hashIdentifier{
                                                                          hashIdentifier} {};
  CryptoAlgorithmIdentifier identifier() final {
    return CryptoAlgorithmIdentifier::RSASSA_PKCS1_v1_5;
  };
...
public:
  ...
  std::span<uint8_t> publicExponent;
  CryptoAlgorithmIdentifier hashIdentifier;
  CryptoAlgorithmRSA_OAEP_Key(size_t modulusLength, std::span<uint8_t> publicExponent,
                              CryptoAlgorithmIdentifier hashIdentifier)
      : modulusLength{modulusLength}, publicExponent{publicExponent}, hashIdentifier{
                                                                          hashIdentifier} {};

  const char *name() const noexcept override { return "RSA-OAEP"; };

  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::RSA_OAEP; };
...
public:
  CryptoAlgorithmIdentifier hashIdentifier;
  CryptoAlgorithmRSA_OAEP_KeyImport(CryptoAlgorithmIdentifier hashIdentifier)
      : hashIdentifier{hashIdentifier} {};
...
public:
  // An ArrayBuffer, a TypedArray, or a DataView — an array of bytes that does not itself need to be
  // encrypted but which should be bound to the ciphertext. A digest of the label is part of the
  // input to the encryption operation. Unless your application calls for a label, you can just omit
...
public:
  ...
  const char *name() const noexcept override { return "RSA-PSS"; };
  CryptoAlgorithmRSA_PSS_Key(size_t modulusLength, std::span<uint8_t> publicExponent,
                             CryptoAlgorithmIdentifier hashIdentifier)
      : modulusLength{modulusLength}, publicExponent{publicExponent}, hashIdentifier{
                                                                          hashIdentifier} {}
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::RSA_PSS; };
...
public:
  ...
  const char *name() const noexcept override { return "RSA-PSS"; };
  CryptoAlgorithmRSA_PSS_KeyImport(CryptoAlgorithmIdentifier hashIdentifier)
      : hashIdentifier{hashIdentifier} {}
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::RSA_PSS; };
...
public:
  ...
  // RFC 3447 says that "Typical salt lengths" are either 0 or the length of the output of the
  // digest algorithm that was selected when this key was generated. For example, if you use SHA-256
  // as the digest algorithm, this could be 32. The maximum size of saltLength is given by:
  // Math.ceil((keySizeInBits - 1)/8) - digestSizeInBytes - 2
  // So for a key length of 2048 bits and a digest output size of 32 bytes, the maximum size would
  // be 222.
  size_t saltLength;
  const char *name() const noexcept override { return "RSA-PSS"; };
...
public:
  const char *name() const noexcept override { return "SHA-224"; };
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::SHA_224; };
  JSObject *digest(JSContext *cx, std::span<uint8_t>) override;
  JSObject *toObject(JSContext *cx) override;
};
...
public:
  ...
  // However, it need not be secret (for example, it may be transmitted unencrypted along with the
  // ciphertext).
  std::span<uint8_t> iv;

  enum class Padding : uint8_t { Yes, No };

  const char *name() const noexcept override { return "AES-CBC"; };
  CryptoAlgorithmAES_CBC_EncDec(std::span<uint8_t> iv) : iv{iv} {}
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::AES_CBC; };
...
class CryptoAlgorithmAES_CBC_Key final : public CryptoAlgorithmGenerateKey,
                                         public CryptoAlgorithmGetKeyLength {
public:
...
public:
  ...
  const char *name() const noexcept override { return "AES-CFB-8"; };
  CryptoAlgorithmAES_CFB_EncDec(std::span<uint8_t> iv) : iv{iv} {}
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::AES_CFB; };
...
class CryptoAlgorithmAES_CFB_Key final : public CryptoAlgorithmGenerateKey,
                                         public CryptoAlgorithmGetKeyLength {
public:
  // A Number — the length in bits of the key to generate. This must be one of: 128, 192, or 256.
  unsigned short length;
...
public:
  // An ArrayBuffer, a TypedArray, or a DataView — the initial value of the counter block. This must
  // be 16 bytes long (the AES block size). The rightmost length bits of this block are used for the
  // counter, and the rest is used for the nonce. For example, if length is set to 64, then the
  // first half of counter is the nonce and the second half is used for the counter.
  std::span<uint8_t> counter;
  // A Number — the number of bits in the counter block that are used for the actual counter. The
  // counter must be big enough that it doesn't wrap: if the message is n blocks and the counter is
  // m bits long, then the following must be true: n <= 2^m. The NIST SP800-38A standard, which
  // defines CTR, suggests that the counter should occupy half of the counter block (see Appendix
  // B.2), so for AES it would be 64.
  size_t length;

  const char *name() const noexcept override { return "AES-CTR"; };
  CryptoAlgorithmAES_CTR_EncDec(std::span<uint8_t> counter, size_t length)
      : counter{counter}, length{length} {}

  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::AES_CTR; };
...
class CryptoAlgorithmAES_CTR_Key final : public CryptoAlgorithmGenerateKey,
                                         public CryptoAlgorithmImportKey,
                                         public CryptoAlgorithmGetKeyLength {
public:
  // A Number — the length in bits of the key to generate. This must be one of: 128, 192, or 256.
...
public:
  // An ArrayBuffer, a TypedArray, or a DataView with the initialization vector. This must be unique
  // for every encryption operation carried out with a given key. Put another way: never reuse an IV
  // with the same key. The AES-GCM specification recommends that the IV should be 96 bits long, and
  // typically contains bits from a random number generator. Section 8.2 of the specification
  // outlines methods for constructing IVs. Note that the IV does not have to be secret, just
  // unique: so it is OK, for example, to transmit it in the clear alongside the encrypted message.
  std::span<uint8_t> iv;

  // An ArrayBuffer, a TypedArray, or a DataView. This contains additional data that will not be
  ...
  // This gives you a way to authenticate associated data without having to encrypt it. The bit
  // length of additionalData must be smaller than 2^64 - 1. The additionalData property is optional
  // and may be omitted without compromising the security of the encryption operation.
  std::optional<std::span<uint8_t>> additionalData;

  // A Number. This determines the size in bits of the authentication tag generated in the
  // encryption operation and used for authentication in the corresponding decryption. According to
  // the Web Crypto specification this must have one of the following values: 32, 64, 96, 104, 112,
  // 120, or 128. The AES-GCM specification recommends that it should be 96, 104, 112, 120 or 128,
  // although 32 or 64 bits may be acceptable in some applications: Appendix C of the specification
  // provides additional guidance here. tagLength is optional and defaults to 128 if it is not
  // specified.
  std::optional<uint8_t> tagLength;

  const char *name() const noexcept override { return "AES-GCM"; };
  CryptoAlgorithmAES_GCM_EncDec(std::span<uint8_t> iv,
                                std::optional<std::span<uint8_t>> additionalData,
                                std::optional<uint8_t> tagLength)
      : iv{iv}, additionalData{additionalData}, tagLength{tagLength} {};
  CryptoAlgorithmIdentifier identifier() final { return CryptoAlgorithmIdentifier::AES_GCM; };
...
class CryptoAlgorithmAES_GCM_Key final : public CryptoAlgorithmGenerateKey,
                                         public CryptoAlgorithmGetKeyLength {
public:
  // A Number — the length in bits of the key to generate. This must be one of: 128, 192, or 256.
  unsigned short length;
  ...
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::AES_GCM; };
...
class CryptoAlgorithmAES_KW final : public CryptoAlgorithmWrapUnwrapkey,
                                    public CryptoAlgorithmGenerateKey,
                                    public CryptoAlgorithmGetKeyLength {
public:
  // A Number — the length in bits of the key to generate. This must be one of: 128, 192, or 256.
  ...
  const char *name() const noexcept override { return "AES-KW"; };
  CryptoAlgorithmAES_KW(unsigned short length) : length{length} {};
  CryptoAlgorithmIdentifier identifier() override { return CryptoAlgorithmIdentifier::AES_KW; };
