...
int c_at_e_init(uint64_t abi_version);

// Module fastly_uap
WASM_IMPORT("fastly_uap", "parse")
int c_at_e_uap_parse(const char *user_agent, size_t user_agent_len, char *family,
                     size_t family_max_len, size_t *family_nwritten, char *major,
                     size_t major_max_len, size_t *major_nwritten, char *minor,
                     size_t minor_max_len, size_t *minor_nwritten, char *patch,
                     size_t patch_max_len, size_t *patch_nwritten);

// Module fastly_http_body
WASM_IMPORT("fastly_http_body", "append")
int c_at_e_body_append(fastly_body_handle_t dst_handle, fastly_body_handle_t src_handle);

WASM_IMPORT("fastly_http_body", "new")
int c_at_e_body_new(fastly_body_handle_t *handle_out);

WASM_IMPORT("fastly_http_body", "read")
int c_at_e_body_read(fastly_body_handle_t body_handle, char *buf, size_t buf_len, size_t *nread);

WASM_IMPORT("fastly_http_body", "write")
int c_at_e_body_write(fastly_body_handle_t body_handle, const char *buf, size_t buf_len,
                      BodyWriteEnd end, size_t *nwritten);

WASM_IMPORT("fastly_http_body", "close")
int c_at_e_body_close(fastly_body_handle_t body_handle);

// Module fastly_log
WASM_IMPORT("fastly_log", "endpoint_get")
int c_at_e_log_endpoint_get(const char *name, size_t name_len,
                            fastly_log_endpoint_handle_t *endpoint_handle);

WASM_IMPORT("fastly_log", "write")
int c_at_e_log_write(fastly_log_endpoint_handle_t endpoint_handle, const char *msg, size_t msg_len,
                     size_t *nwritten);

// Module fastly_http_req
WASM_IMPORT("fastly_http_req", "register_dynamic_backend")
int c_at_e_req_register_dynamic_backend(const char *name_prefix, size_t name_prefix_len,
...
int c_at_e_req_body_downstream_get(fastly_request_handle_t *req_handle_out,
 ...
 *
 * c_at_e_req_cache_override_v2_set also includes an optional Surrogate-Key which will be set or
 * added to any received from the origin.
 */

WASM_IMPORT("fastly_http_req", "cache_override_set")
int c_at_e_req_cache_override_set(fastly_request_handle_t req_handle, int tag, uint32_t ttl,
                                  uint32_t stale_while_revalidate);

WASM_IMPORT("fastly_http_req", "cache_override_v2_set")
int c_at_e_req_cache_override_v2_set(fastly_request_handle_t req_handle, int tag, uint32_t ttl,
...
int c_at_e_req_downstream_client_ip_addr_get(char *octets, size_t *nwritten);
...
int c_at_e_req_new(fastly_request_handle_t *req_handle_out);

WASM_IMPORT("fastly_http_req", "header_names_get")
int c_at_e_req_header_names_get(fastly_request_handle_t req_handle, char *buf, size_t buf_len,
                                uint32_t cursor, int64_t *ending_cursor, size_t *nwritten);

WASM_IMPORT("fastly_http_req", "original_header_names_get")
int c_at_e_req_original_header_names_get(char *buf, size_t buf_len, uint32_t cursor,
                                         int64_t *ending_cursor, size_t *nwritten);

WASM_IMPORT("fastly_http_req", "original_header_count")
int c_at_e_req_original_header_count(uint32_t *count);

WASM_IMPORT("fastly_http_req", "header_value_get")
int c_at_e_req_header_value_get(fastly_request_handle_t req_handle, const char *name,
                                size_t name_len, char *value, size_t value_max_len,
                                size_t *nwritten);

WASM_IMPORT("fastly_http_req", "header_values_get")
int c_at_e_req_header_values_get(fastly_request_handle_t req_handle, const char *name,
                                 size_t name_len, char *buf, size_t buf_len, uint32_t cursor,
                                 int64_t *ending_cursor, size_t *nwritten);

WASM_IMPORT("fastly_http_req", "header_insert")
int c_at_e_req_header_insert(fastly_request_handle_t req_handle, const char *name, size_t name_len,
                             const char *value, size_t value_len);

WASM_IMPORT("fastly_http_req", "header_append")
int c_at_e_req_header_append(fastly_request_handle_t req_handle, const char *name, size_t name_len,
                             const char *value, size_t value_len);

WASM_IMPORT("fastly_http_req", "header_remove")
int c_at_e_req_header_remove(fastly_request_handle_t req_handle, const char *name, size_t name_len);

WASM_IMPORT("fastly_http_req", "method_get")
int c_at_e_req_method_get(fastly_request_handle_t req_handle, char *method, size_t method_max_len,
                          size_t *nwritten);

WASM_IMPORT("fastly_http_req", "method_set")
int c_at_e_req_method_set(fastly_request_handle_t req_handle, const char *method,
                          size_t method_len);

WASM_IMPORT("fastly_http_req", "uri_get")
int c_at_e_req_uri_get(fastly_request_handle_t req_handle, char *uri, size_t uri_max_len,
                       size_t *nwritten);

WASM_IMPORT("fastly_http_req", "uri_set")
int c_at_e_req_uri_set(fastly_request_handle_t req_handle, const char *uri, size_t uri_len);

WASM_IMPORT("fastly_http_req", "version_get")
int c_at_e_req_version_get(fastly_request_handle_t req_handle, uint32_t *version);

WASM_IMPORT("fastly_http_req", "version_set")
int c_at_e_req_version_set(fastly_request_handle_t req_handle, uint32_t version);

WASM_IMPORT("fastly_http_req", "send")
int c_at_e_req_send(fastly_request_handle_t req_handle, fastly_body_handle_t body_handle,
...
int c_at_e_req_send_async(fastly_request_handle_t req_handle, fastly_body_handle_t body_handle,
                          const char *backend, size_t backend_len,
                          fastly_pending_request_handle_t *pending_req_out);

WASM_IMPORT("fastly_http_req", "send_async_streaming")
int c_at_e_req_send_async_streaming(fastly_request_handle_t req_handle,
                                    fastly_body_handle_t body_handle, const char *backend,
                                    size_t backend_len,
                                    fastly_pending_request_handle_t *pending_req_out);

WASM_IMPORT("fastly_http_req", "pending_req_poll")
int c_at_e_req_pending_req_poll(fastly_pending_request_handle_t req_handle, uint32_t *is_done_out,
                                fastly_response_handle_t *resp_handle_out,
                                fastly_body_handle_t *resp_body_handle_out);

WASM_IMPORT("fastly_http_req", "pending_req_select")
int c_at_e_req_pending_req_select(fastly_pending_request_handle_t req_handles[],
                                  size_t req_handles_len, uint32_t *done_idx_out,
                                  fastly_response_handle_t *resp_handle_out,
                                  fastly_body_handle_t *resp_body_handle_out);

WASM_IMPORT("fastly_http_req", "pending_req_wait")
int c_at_e_req_pending_req_wait(fastly_pending_request_handle_t req_handle,
                                fastly_response_handle_t *resp_handle_out,
                                fastly_body_handle_t *resp_body_handle_out);

// Module fastly_http_resp
WASM_IMPORT("fastly_http_resp", "new")
int c_at_e_resp_new(fastly_response_handle_t *resp_handle_out);

WASM_IMPORT("fastly_http_resp", "header_names_get")
int c_at_e_resp_header_names_get(fastly_response_handle_t resp_handle, char *buf, size_t buf_len,
                                 uint32_t cursor, int64_t *ending_cursor, size_t *nwritten);

WASM_IMPORT("fastly_http_resp", "header_values_get")
int c_at_e_resp_header_values_get(fastly_response_handle_t resp_handle, const char *name,
                                  size_t name_len, char *buf, size_t buf_len, uint32_t cursor,
                                  int64_t *ending_cursor, size_t *nwritten);

WASM_IMPORT("fastly_http_req", "header_values_set")
int c_at_e_req_header_values_set(fastly_request_handle_t req_handle, const char *name,
                                 size_t name_len, const char *values, size_t values_len);

WASM_IMPORT("fastly_http_resp", "header_insert")
int c_at_e_resp_header_insert(fastly_response_handle_t resp_handle, const char *name,
                              size_t name_len, const char *value, size_t value_len);

WASM_IMPORT("fastly_http_resp", "header_append")
int c_at_e_resp_header_append(fastly_response_handle_t resp_handle, const char *name,
                              size_t name_len, const char *value, size_t value_len);

WASM_IMPORT("fastly_http_resp", "header_remove")
int c_at_e_resp_header_remove(fastly_response_handle_t resp_handle, const char *name,
                              size_t name_len);

WASM_IMPORT("fastly_http_resp", "version_get")
int c_at_e_resp_version_get(fastly_response_handle_t resp_handle, uint32_t *version_out);

WASM_IMPORT("fastly_http_resp", "send_downstream")
int c_at_e_resp_send_downstream(fastly_response_handle_t resp_handle,
                                fastly_body_handle_t body_handle, uint32_t streaming);

WASM_IMPORT("fastly_http_resp", "status_get")
int c_at_e_resp_status_get(fastly_response_handle_t resp_handle, uint16_t *status_out);

WASM_IMPORT("fastly_http_resp", "status_set")
int c_at_e_resp_status_set(fastly_response_handle_t resp_handle, uint16_t status);

// Module fastly_dictionary
WASM_IMPORT("fastly_dictionary", "open")
int c_at_e_dictionary_open(const char *name, size_t name_len,
                           fastly_dictionary_handle_t *dict_handle_out);

WASM_IMPORT("fastly_dictionary", "get")
int c_at_e_dictionary_get(fastly_dictionary_handle_t dict_handle, const char *key, size_t key_len,
                          char *value, size_t value_max_len, size_t *nwritten);

// Module fastly_secret_store
WASM_IMPORT("fastly_secret_store", "open")
int c_at_e_secret_store_open(const char *name, size_t name_len,
                             fastly_secret_store_handle_t *dict_handle_out);

WASM_IMPORT("fastly_secret_store", "get")
int c_at_e_secret_store_get(fastly_secret_store_handle_t dict_handle, const char *key,
                            size_t key_len, fastly_secret_handle_t *opt_secret_handle_out);

WASM_IMPORT("fastly_secret_store", "plaintext")
int c_at_e_secret_store_plaintext(fastly_secret_handle_t secret_handle, char *buf, size_t buf_len,
                                  size_t *nwritten);

// Module fastly_object_store
WASM_IMPORT("fastly_object_store", "open")
int c_at_e_object_store_open(const char *name, size_t name_len,
                             fastly_object_store_handle_t *object_store_handle_out);
WASM_IMPORT("fastly_object_store", "lookup")
int c_at_e_object_store_get(fastly_object_store_handle_t object_store_handle, const char *key,
                            size_t key_len, fastly_body_handle_t *opt_body_handle_out);
WASM_IMPORT("fastly_object_store", "insert")
int c_at_e_object_store_insert(fastly_object_store_handle_t object_store_handle, const char *key,
                               size_t key_len, fastly_body_handle_t body_handle);
WASM_IMPORT("fastly_geo", "lookup")
int c_at_e_geo_lookup(const char *addr_octets, size_t addr_len, char *buf, size_t buf_len,
                      size_t *nwritten);
...
int c_at_e_async_select(fastly_async_handle_t handles[], size_t handles_len, uint32_t timeout_ms,
...
int c_at_e_async_is_ready(fastly_async_handle_t handle, uint32_t *is_ready_out);
