...
typedef struct {
  char*ptr;
  size_t len;
} c_at_e_world_string_t;

typedef struct {
  c_at_e_world_string_t family;
  c_at_e_world_string_t major;
  c_at_e_world_string_t minor;
  c_at_e_world_string_t patch;
} fastly_user_agent_t;
