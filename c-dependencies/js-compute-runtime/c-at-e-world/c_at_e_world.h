...
bool fastly_http_req_downstream_tls_cipher_openssl_name(c_at_e_world_string_t *ret,
                                                        fastly_error_t *err);
...
bool fastly_http_req_header_names_get(fastly_request_handle_t h, fastly_list_string_t *ret,
                                      fastly_error_t *err);
bool fastly_http_req_header_value_get(fastly_request_handle_t h, c_at_e_world_string_t *name,
...
bool fastly_http_req_header_values_set(fastly_request_handle_t h, c_at_e_world_string_t *name,
...
bool fastly_http_req_redirect_to_websocket_proxy(c_at_e_world_string_t *backend,
                                                 fastly_error_t *err);
...
bool fastly_http_resp_header_names_get(fastly_response_handle_t h, fastly_list_string_t *ret,
                                       fastly_error_t *err);
bool fastly_http_resp_header_value_get(fastly_response_handle_t h, c_at_e_world_string_t *name,
                                       fastly_option_string_t *ret, fastly_error_t *err);
bool fastly_http_resp_header_values_get(fastly_response_handle_t h, c_at_e_world_string_t *name,
                                        fastly_option_list_string_t *ret, fastly_error_t *err);
bool fastly_http_resp_header_values_set(fastly_response_handle_t h, c_at_e_world_string_t *name,
                                        fastly_list_string_t *values, fastly_error_t *err);
